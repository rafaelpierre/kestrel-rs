...
`bing-unrelated.html` is synthetic. Its full-query document title and unrelated organic entries exercise faithful parsing and the current result-count stopping policy; it does not establish live Bing behavior or semantic relevance.
